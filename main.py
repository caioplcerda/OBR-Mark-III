...
class Robot:
    ...
    def _loop(self):
        try:
            while self.running:
                ...
                is_intersection, is_curve90, is_curve180 = self._detect_intersection(bw, widths, cents, angle)
    ...
    def _detect_intersection(self, bw, widths, cents, angle_deg):
        ...
        # 90-degree turn: moderate angle (30-60 degrees)
        # 180-degree curve: very high angle (60+ degrees)
        ang_90_turn = 30 <= abs(angle_deg) <= 60
        ang_180_curve = abs(angle_deg) > 60
        return wide, ang_90_turn, ang_180_curve
